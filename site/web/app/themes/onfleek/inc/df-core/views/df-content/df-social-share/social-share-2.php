...
<div class="style2 df-post-sharing <?php echo esc_attr( $top_class ); echo esc_attr( $general_layout == 'layout-8' ) ? ' mobile':'';?> df-social-share">
		...
		?>	
		 	<li class="df-social-sharing-buttons pinterest popup">
		...
		?>		3
		 	<li class="df-social-sharing-buttons style2">
				...
				<ul class="more-social style2">
					...
					?>
					<li class="popup"><a href="mailto:?Subject=&Body=I%20saw%20this%20and%20thought%20of%20you!%20 <?php echo esc_url( get_permalink( get_the_ID() ) ) ?>">Email</a></li>
					<?php 
						}
					?>
				</ul>
