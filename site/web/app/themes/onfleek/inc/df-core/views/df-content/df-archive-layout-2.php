			...
			<div class="container">
				<div class="row">
					...
					<div id="df-content-render" class="<?php echo esc_attr( $column );?> no-padding animsition df-content-sticky push-bottom-4 clearfix" data-id="<?php echo esc_attr( get_query_var( 'paged' ) );?>">
						...
						?>
										<div class="<?php echo esc_attr( $column_md );?> col-sm-6 col-xs-12 archive-wraper style-2">
						...
						?>	
										<div class="<?php echo esc_attr( $column_md );?> col-sm-6 col-xs-12 archive-wraper style-2">
											...
											<div class="post-meta with-margin-top">
												<div class="post-meta-avatar">
													<?php echo get_avatar( get_the_author_meta( 'ID' ), 32, $default = '', $alt = 'author_avatar', array( 'class' => 'img-responsive center-block img-circle' ) );?>
												</div>
												<div class="post-meta-desc with-avatar">
													<div class="post-meta-desc-top">
														<?php DF_Content::df_load_author_and_date();?>
